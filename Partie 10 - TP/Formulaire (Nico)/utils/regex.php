<?php
//Ici j'utilise la fonction define() qui me permet de nommé des superGlobal que j'utilise ensuite dans mon controller (ici je leurs passe les regexs).
...
//Ici je définie un superGLobal que j'appelle BASE_URL qui j'utilise pour ensuite appeler mon css / script dans le header/footer
define('BASE_URL', $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'].'/Formulaire');