...
<body>
    <div class="container">
        ...
        <p>Faire un formulaire qui permet de récupérer le <strong>login</strong> et le <strong>mot de passe</strong> de
            l'utilisateur.</p>
        <p>À la validation du formulaire, stocker les informations dans un <strong>cookie</strong>.</p>
        <hr />
